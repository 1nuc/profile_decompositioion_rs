...
use crate::{EagerActions, dl::{inference::Inference, models::{bi_lstm::NucBiLstmConfig, hybrid_models::Seq2SeqConfig, lstm::NucLstmConfig, stacked_bi_lstm::StackedBiLstmConfig, stacked_lstm::StackedLstmConfig}, training::NrelConfig}};
...
impl Controller{
    ...
    pub fn train_lstm<B: AutodiffBackend>(&self,device: B::Device){
        let model=StackedBiLstmConfig::default();
